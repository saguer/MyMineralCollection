 ...
 */
public class ListResult_HTML extends View implements View.OnClickListener{

    //------------------------------------------------
    private Context context;

    private ListHTMLResultMineralPropItem_interface mInterface;
    ...
    public ListResult_HTML(Fragment fragCarSettings, LinearLayout _itemParentLayout, Bundle _bundle) {
        ...
        this.mInterface = (ListHTMLResultMineralPropItem_interface) fragCarSettings;
    ...
    private void init(View view){
        ...
        this.propertyInfo_textView.setHtml(temp);
    ...
    public interface ListHTMLResultMineralPropItem_interface {
