 ...
 */
public class MineralInfoFrag extends Fragment implements View.OnClickListener {
    public MineralInfoFrag() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.mineral_info, container, false);
        context = getActivity();
