...
public class Label extends LinearLayout {
    ...
    public Label(Context context, int textSize, int iconCross,
                 boolean showCross, boolean addBorder, int textColor, int backgroundResource, boolean labelsClickables, int padding) {
        super(context);
        init(context, textSize, iconCross, showCross, addBorder, textColor,
    ...
    private void init(final Context context, int textSize, int iconCross,
        ...
        Log.d("Label", "Label: "+addBorder);
        Log.d("Label", "TODO: pass the border resource");
