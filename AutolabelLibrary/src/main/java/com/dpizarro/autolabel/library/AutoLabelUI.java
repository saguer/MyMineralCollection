...
public class AutoLabelUI extends AutoViewGroup implements Label.OnClickCrossListener, Label.OnLabelClickListener {
    ...
    private boolean mAddBorder = AutoLabelUISettings.DEFAULT_ADD_BORDER;
    ...
    private void getAttributes(AttributeSet attrs) {
        ...
        if (typedArray != null) {
            try {
                ...
                mAddBorder = typedArray.getBoolean(R.styleable.LabelsView_show_border,
                        AutoLabelUISettings.DEFAULT_ADD_BORDER);
    ...
    public boolean addLabel(String textLabel, int position) {
        if (!checkLabelsCompleted()) {
            Label label = new Label(getContext(), mTextSize, mIconCross, mShowCross, mAddBorder,
    ...
    public void setSettings(AutoLabelUISettings autoLabelUISettings) {
        ...
        setAddBorder(autoLabelUISettings.isAddBorder());
