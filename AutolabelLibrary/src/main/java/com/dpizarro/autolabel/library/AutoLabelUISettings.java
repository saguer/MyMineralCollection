...
public class AutoLabelUISettings implements Parcelable {
    ...
    public static final boolean DEFAULT_SHOW_CROSS          = false;
    public static final boolean DEFAULT_ADD_BORDER          = false;
    ...
    private void setAddBorder(boolean addBorder) {
        mAddBorder = addBorder;
    }
    ...
    public static final class Builder {
        ...
        private boolean mAddBorder          = DEFAULT_ADD_BORDER;
        ...
        public Builder(AutoLabelUISettings copy) {
            ...
            this.mAddBorder = copy.mAddBorder;
        ...
        public Builder withAddBorder(boolean addBorder) {
            this.mAddBorder = addBorder;
            return this;
        }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte(mAddBorder ? (byte) 1 : (byte) 0);
