 ...
 */
public class HtmlExpandableViewHolder extends RecyclerView.ViewHolder {
    ...
    public HtmlExpandableViewHolder(View v) {
        super(v);
    ...
    public void setData(final Context context, final RecyclerView.ViewHolder holder, final RecycleBen bean, final int position, SparseBooleanArray expandState) {
        ...
        ((HtmlExpandableViewHolder)holder).description_textView.setText(description);
        ((HtmlExpandableViewHolder)holder).data_textView.setHtml(dataText);

        if(tittleTextColor != -1) ((HtmlExpandableViewHolder)holder).description_textView.setTextColor(ContextCompat.getColor(context, tittleTextColor));
        if(tittleTextAreaColor != -1) ((HtmlExpandableViewHolder)holder).itemView.setBackgroundColor(ContextCompat.getColor(context, tittleTextAreaColor));
        if(expandableTextAreaColor != -1) ((HtmlExpandableViewHolder)holder).expandableLayout.setBackgroundColor(ContextCompat.getColor(context, expandableTextAreaColor));

        if(separationLineColor != -1){
            showSeparationLine = true;
            ((HtmlExpandableViewHolder)holder).separationLineFragmentLayout.setBackgroundColor(ContextCompat.getColor(context, separationLineColor));
        }
        ...
        if(this.expandState.get(position)){
            ...
            ((HtmlExpandableViewHolder) holder).expand_imageView.setOnClickListener(new View.OnClickListener() {
                @Override
        ...
        ((HtmlExpandableViewHolder)holder).expandableLayout.setDuration(animationSpeed);
        ((HtmlExpandableViewHolder)holder).expandableLayout.setInRecyclerView(true);
        //((ExpandableViewHolder)holder).expandableLayout.setInterpolator(bean.interpolator);
        ((HtmlExpandableViewHolder)holder).expandableLayout.setInterpolator(Utils.createInterpolator(Utils.ACCELERATE_DECELERATE_INTERPOLATOR));

        ((HtmlExpandableViewHolder)holder).expandableLayout.setExpanded(this.expandState.get(position));
        ((HtmlExpandableViewHolder)holder).expandableLayout.setListener(new ExpandableLayoutListenerAdapter() {

            @Override
            public void onPreOpen() {
                ((HtmlExpandableViewHolder)holder).expandableLayout.initLayout();//<< looks like it's preventing a bug that
                HtmlExpandableViewHolder.this.expandState.put(position, true);
                ...
                if(showExpand) {
                    ((HtmlExpandableViewHolder) holder).expand_imageView.animate()
                            ...
                            .setListener(new AnimatorListenerAdapter() {
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    ...
                                    ((HtmlExpandableViewHolder) holder).expand_imageView.setVisibility(View.VISIBLE);
                ...
                if(showSeparationLine) {
                    ((HtmlExpandableViewHolder) holder).separationLineFragmentLayout.animate()
                            //.translationY(holder.expand_imageView.getHeight())
                            .alpha(1.0f)
                            .setDuration(animationSpeed)
                            .setListener(new AnimatorListenerAdapter() {
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    super.onAnimationEnd(animation);
                                    ((HtmlExpandableViewHolder) holder).separationLineFragmentLayout.setVisibility(View.VISIBLE);
            ...
            public void onPreClose() {
                HtmlExpandableViewHolder.this.expandState.put(position, false);
                //Todo: fix this. or add a simple arrow fade
                ...
                if(showExpand) {
                    ((HtmlExpandableViewHolder) holder).expand_imageView.animate()
                            ...
                            .setListener(new AnimatorListenerAdapter() {
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    super.onAnimationEnd(animation);
                                    ((HtmlExpandableViewHolder) holder).expand_imageView.setVisibility(View.INVISIBLE);

                                    ((HtmlExpandableViewHolder) holder).expand_imageView.setOnClickListener(null);
                ...
                if(showSeparationLine) {
                    ((HtmlExpandableViewHolder) holder).separationLineFragmentLayout.animate()
                            ...
                            .setListener(new AnimatorListenerAdapter() {
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    super.onAnimationEnd(animation);
                                    ((HtmlExpandableViewHolder) holder).separationLineFragmentLayout.setVisibility(View.INVISIBLE);
        ...
        ((HtmlExpandableViewHolder)holder).expand_arrow_imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View v) {
                onClickButton(((HtmlExpandableViewHolder)holder).expandableLayout);
            }
        });

        ((HtmlExpandableViewHolder)holder).item_linearLayout.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
    ...
    private void showExpand(RecyclerView.ViewHolder holder, int animationSpeed){
        ((HtmlExpandableViewHolder)holder).expand_arrow_imageView.animate()
                .rotation(0)
                .setDuration(animationSpeed)
                .start();
    }
