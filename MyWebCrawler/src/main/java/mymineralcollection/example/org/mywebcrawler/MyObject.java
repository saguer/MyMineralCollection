...
public class MyObject {
    ...
    public void printMyObjc(String TAG){
        Log.e(TAG, "-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*");
        Log.d(TAG, "---- printMyObjc ----");
        Log.d(TAG, "objectMineralName: "+getMineralName());

        Log.d(TAG, "tableOrigin: "+getTableOrigin());
        Log.d(TAG, "Mineral Previous Search      : "+getPrevSearch());
        Log.d(TAG, "Mineral In Personal DataBase : "+getInPersonaldb());
        Log.d(TAG, "Mineral Search Success       : "+getSearchSuccess());

        Log.d(TAG, "objectId: "+getId());
        Log.d(TAG, "Search Result Percent: "+getMineralPercent());
        Log.d(TAG, "Mineral Counter: "+getObjectMineralCounter());
        Log.e(TAG, "-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*");
    }
    public void printMyObjcShort(String TAG){
        Log.d(TAG, "objectMineralName: "+getMineralName() + " - " +getTableOrigin());
    }
}
